...
def main():
    ...
    mass = float(input("Enter the mass of the formula in grams:"))

    chemical_list = parse_formula(chemical_formula, periodic_table)
    molar_mass = compute_molar_mass(chemical_list, periodic_table)
